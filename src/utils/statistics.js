const calculateStatistics = (array) => {
  return {
    ...
    generateLinkWolfram: generateLinkWolfram(array)
  };
};
...
const generateLinkWolfram = (array) => {
  const data = encodeURIComponent(array.join(','))

  return `https://www.wolframalpha.com/input?i=[${data}]`
}
