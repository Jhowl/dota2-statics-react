...
/* <li>Min: {durationStatistics.min}</li>
<li>Max: {durationStatistics.max}</li>
<li>Average: {durationStatistics.average}</li>
<li>Standard Deviation: {durationStatistics.standardDeviation}</li>
<li>Median: {durationStatistics.median}</li>
<li>Mode: {durationStatistics.mode}</li>
<li>Variance: {durationStatistics.variance}</li>
...
const calculateStatistics = (array) => {
  ...
  const standardDeviationbyScore = (array) => {
    const scores = array.reduce((acc, curr) => {
      ...
      acc.fortyFour = curr < 44.5 ? acc.fortyFour + 1 : acc.fortyFour
